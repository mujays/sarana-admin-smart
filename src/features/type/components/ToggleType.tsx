...
import { PoweroffOutlined, SwitcherFilled } from "@ant-design/icons";
import { TType } from "@/services/type/type.type";

export function ToggleType({ typeId, data }: { typeId: number; data: TType }) {
  ...
  async function handleStatus() {
    try {
      setIsLoading(true);
      await TypeServices.update(typeId, {
        ...data,
